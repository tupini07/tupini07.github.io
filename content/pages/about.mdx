...
This site is mainly for myself, so I apologize if you encounter any cryptic or incomprehensible thing (it was probably
written with _me_ in mind). There may be some notes that are good enough for human consumption, but for the most part
...
higher level [_notes_](/) (although they are more like longer notes than anything else), which use the _zettlekasten_
...
script](https://github.com/tupini07/tupini07.github.io/blob/dev/scripts/import-org-roam). This ensures that
