...
<figure>
  <blockquote>
    <p>
      ...
      very neat and legible, not at all difficult to follow—your grace would be able to read it
...
<figure>
  <blockquote>
    <p>
      It is a press, certainly, but a press from which shall flow in inexhaustible streams… Through
