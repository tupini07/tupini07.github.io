...
given by [!AWS-ACM](WID:20200803145314-aws_acm) for this. If this is the
case then we first need to request the certificate so that the domain
can be used, before adding the domain can be added as a valid alternate
domain.
